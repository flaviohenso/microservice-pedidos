...
class CriarPedidoUseCaseTest {
    ...
    void deveCriarPedidoComSucesso() {
        // Arrange
        Long clienteId = 123L;
        List<ItemPedidoRequest> itensRequest = List.of(new ItemPedidoRequest(1L, 2), new ItemPedidoRequest(2L, 1));
        ...
        when(pedidoRepository.salvar(any(Pedido.class))).thenAnswer(invocation -> {
            ...
            // Simula que o banco de dados atribuiu um ID ao salvar
            return new Pedido(
                1L,  // ID gerado pelo "banco"
    ...
    void deveLancarExcecaoQuandoProdutoNaoEncontrado() {
        // Arrange
        Long clienteId = 123L;
        List<ItemPedidoRequest> itensRequest = List.of(new ItemPedidoRequest(999L, 1));
    ...
    void deveLancarExcecaoQuandoEstoqueInsuficiente() {
        // Arrange
        Long clienteId = 123L;
        List<ItemPedidoRequest> itensRequest = List.of(new ItemPedidoRequest(1L, 100));
